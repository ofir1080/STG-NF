...
def init_sub_args_single(args):
    ...
    path = os.path.join(path, "singal_data")
    path_vid_frames = os.path.join(path, dataset, 'test/frames/')
    path_pose =  os.path.join(path, dataset, 'pose', 'test/')
